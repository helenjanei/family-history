      ...
      <div className="cards_container"> 
        <div className="cards_wrapper"> 
          ...
          <li className='cards__item'>
            <IntroSection label='Who am I?' text='My name is John and I am your great-great-great-great-grandfather.' src={JohnPollardCut} url={JohnPollard}/>
          ...
          <li className='cards__item'> 
 <InfoSection label="Wiswell" text="My family line in Wiswell goes back at least until XXX" text2="'This township occupies both slopes of a ridge from 1,000 to 600 ft. high which shoots out from Pendle south-west towards Whalley. Fine views over Ribblesdale may be had from it.'" text3="'There are calico printing works at Barrow. The land is used for pasture; the soil is clay. There is a quarry.'"  url='https://www.british-history.ac.uk/vch/lancs/vol6/pp396-399' src={wiswellPub}/>
...
<InfoSection label='Where are our children?'text="Only our youngest two children, Thomas and Mary Jane are still living in Clitheroe in 1871. Thomas lives with his wife's parents and Mary Jane lives with her husband and her mother, my wife Catherine." text2="However, by the 1881 census Thomas has moved to Westhoughton. Mary Jane is the only one of our seven children to remain in Clitheroe, her husband Newton Aspen is listed in 1881 was being a coal wharehouse(?) employing three men." text3="It would seem our children remained in close contact as in 1886 John died in Stockport, and his two brothers George and WIlliam, both of Hayford Derbyshire as his executors." src={JohnJrProbate}/> 
 </li>
<li className='cards__item'> 
                   <InfoSection label='Portraits' text="The portrait photographs of my wife and I seem to have been taken in our later age. Since it is unusual for people of our background to have our photographs taken at this time." text2="Perhaps the portraits were taken before I departed for Stockport in order that we could have a photograph of each other whilst apart." src={JohnJr} url='https://maps.nls.uk/view/102340981'/>
